...
class RadarApiService {
    ...
    async fetchLatestFrames(options) {
        ...
        try {
            const url = `${serviceUrl}/api/radar/${encodeURIComponent(state)}/${encodeURIComponent(suburb)}/frames`;
    ...
    async fetchHistoricalFrames(options) {
        ...
        try {
            let url = `${serviceUrl}/api/radar/${encodeURIComponent(state)}/${encodeURIComponent(suburb)}/timeseries`;
            ...
            let metadata = {};
            try {
                const metadataUrl = `${serviceUrl}/api/radar/${encodeURIComponent(state)}/${encodeURIComponent(suburb)}/metadata`;
